...
// to provide us with access to services and processors that we wish to configure
    .config(function(dgeni, log, readFilesProcessor, templateFinder, writeFilesProcessor) {
      ...
      readFilesProcessor.sourceFiles = [
        {
          ...
          include: '../angular-li-authentication/src/**/*.js',
          // ... except for this one!
          exclude: '../angular-li-authentication/src/module.*.js',
        ...
        {
          // Process all js files in `src` and its subfolders ...
          include: '../angular-li-common/src/**/*.js',
          // ... except for this one!
          exclude: '../angular-li-common/src/module.*.js',
          // When calculating the relative path to these files use this as the base path.
          // So `src/foo/bar.js` will have relative path of `foo/bar.js`
          basePath: 'src'
        },
        {
          // Process all js files in `src` and its subfolders ...
          include: '../angular-li-community/src/**/*.js',
          // ... except for this one!
          exclude: '../angular-li-community/src/module.*.js',
          // When calculating the relative path to these files use this as the base path.
          // So `src/foo/bar.js` will have relative path of `foo/bar.js`
          basePath: 'src'
        },
      ...
      writeFilesProcessor.outputFolder  = './../generated';
    })
    ...
    .config(function(
      ...
      generateProtractorTestsProcessor.basePath = './../generated/';
